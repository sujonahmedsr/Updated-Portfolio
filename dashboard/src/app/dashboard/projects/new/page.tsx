    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-[#1E1E1E]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-mono text-[#7CFF6B]">PROJECTS / NEW</span>
            <h1 className="font-heading text-2xl font-bold text-[#F5F5F0]">Create New Project</h1>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-8 rounded-xl bg-[#121212] border border-[#222222] space-y-6 shadow-2xl">
        ...
        {/* Technologies */}
        <div className="space-y-1.5">
          <label className="text-xs font-mono text-[#A1A1A1] block">TECHNOLOGIES (Comma-separated)</label>
          <input
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            rows={5}
            placeholder="Describe project features, architecture, challenge, and results..."
            className="w-full px-4 py-3 rounded-lg bg-[#161616] border border-[#262626] text-sm text-[#F5F5F0] placeholder-[#555] focus:outline-none focus:border-[#7CFF6B] font-sans resize-y"
          />
          {errors.description && (
