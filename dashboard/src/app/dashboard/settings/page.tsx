  ...
  return (
    <div className="space-y-8 font-sans">
      ...
      <div className="pb-4 border-b border-[#1E1E1E]">
        ...
        <h1 className="font-heading text-2xl sm:text-3xl font-bold text-[#F5F5F0]">Settings</h1>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-5">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-heading text-lg font-bold text-[#F5F5F0]">API Connection</h2>
            </div>
            ...
            <div className="p-4 rounded-lg bg-[#161616] border border-[#222222] font-mono text-xs space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {apiStatus === "idle" && <span className="text-[#666]">Not tested yet</span>}
                  {apiStatus === "checking" && (
          ...
          <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-5">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-heading text-lg font-bold text-[#F5F5F0]">Environment Variables</h2>
            </div>
            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="p-3 rounded-lg bg-[#161616] border border-[#222222] flex items-center justify-between">
                ...
                <span className="text-[#7CFF6B] text-[11px]">✓ Set (server-only)</span>
              </div>
              <div className="p-3 rounded-lg bg-[#161616] border border-[#222222] flex items-center justify-between">
            ...
            <p className="text-[11px] text-[#666] font-mono leading-relaxed">
              Credentials are never exposed to the client bundle. To update them, edit <code className="text-[#7CFF6B]">.env.local</code> and redeploy on Vercel.
            </p>
          </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-5">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-heading text-lg font-bold text-[#F5F5F0]">Session Info</h2>
            </div>
          ...
          <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-heading text-lg font-bold text-[#F5F5F0]">About Dashboard</h2>
            </div>
