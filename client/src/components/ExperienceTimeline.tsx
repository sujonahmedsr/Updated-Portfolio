      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-8 sm:mb-12 space-y-4">
          ...
          <p className="text-base text-[#A1A1A1] font-sans leading-relaxed">
            Approximately 1.5+ years of practical development experience
            creating custom Shopify storefronts and modern full-stack web
            applications.
          </p>
        </div>
                ...
                <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs font-mono text-[#7CFF6B]">
                  ...
                  <p className="text-xs text-[#A1A1A1] font-sans leading-relaxed">
                    Delivering end-to-end Shopify theme customization, Liquid
                    section engineering, performance optimization, and custom
                    web applications for client storefronts.
                  </p>
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-3">
                ...
                <p className="text-xs text-[#A1A1A1] font-sans leading-relaxed">
                  Four-year comprehensive diploma program covering computer
                  systems, hardware, networking, database management, and
              ...
              <div className="p-6 rounded-xl bg-[#121212] border border-[#222222] space-y-3">
                ...
                <p className="text-xs text-[#A1A1A1] font-sans leading-relaxed">
                  Completed Secondary School Certificate in Science discipline
                  with focus on Mathematics and Physics.
                </p>
              </div>
            </div>
          </div>
