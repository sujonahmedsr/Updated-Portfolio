...
import { Cpu, ShoppingBag, Layout, Server, Database, Wrench } from "lucide-react";

const techCategories = [
  {
    category: "SHOPIFY DEVELOPMENT",
    icon: <ShoppingBag className="w-5 h-5 text-[#7CFF6B]" />,
    skills: ["Liquid", "Shopify Themes 2.0", "Metafields & Metaobjects", "Shopify APIs", "Shopify Markets", "JSON Templates"]
  },
  {
    category: "FRONTEND ECOSYSTEM",
    icon: <Layout className="w-5 h-5 text-[#7CFF6B]" />,
    skills: ["HTML5", "CSS3", "JavaScript (ES6+)", "TypeScript", "React.js", "Next.js 15", "Redux Toolkit", "Tailwind CSS"]
  },
  {
    category: "BACKEND ARCHITECTURE",
    icon: <Server className="w-5 h-5 text-[#7CFF6B]" />,
    skills: ["Node.js", "Express.js", "REST APIs", "GraphQL APIs", "JWT Auth", "Middleware"]
  },
  {
    category: "DATABASE & PERSISTENCE",
    icon: <Database className="w-5 h-5 text-[#7CFF6B]" />,
    skills: ["MongoDB", "Mongoose ODM", "PostgreSQL", "Prisma ORM", "Data Aggregations"]
  },
  {
...
export default function TechStackSection() {
  return (
    <section id="stack" className="py-24 bg-[#0A0A0A] border-b border-[#1A1A1A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16 space-y-4">
          ...
          <p className="text-base text-[#A1A1A1] font-sans leading-relaxed">
            Categorized tools, frameworks, and languages supporting my daily development workflow.
          </p>
        </div>
