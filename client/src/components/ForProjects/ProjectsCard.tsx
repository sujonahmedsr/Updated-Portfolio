    ...
    <Card className="bg-white p-5 rounded shadow-lg hover:shadow-2xl transition-all dark:bg-gray-800 flex flex-col justify-between">
      <div>
        ...
        <div className="flex items-center justify-between py-4">
          ...
          >
            <FaExternalLinkAlt className="h-4 w-4 mr-2" /> Live Demo
          </a>
      ...
      <div className="text-center mt-4">
        <Link
          ...
          className="inline-block text-blue-600 font-medium hover:underline dark:text-blue-400 dark:hover:text-blue-500"
        >
          View Details
        </Link>
      </div>
