...
const processSteps = [
  {
    ...
    description: "Understand the business requirements, target audience, brand identity, and technical constraints before writing code."
  },
  {
    num: "02",
    title: "DESIGN",
    icon: <Palette className="w-5 h-5 text-[#7CFF6B]" />,
    description: "Translate product specifications into clear, intuitive user flows, responsive layouts, and modern visual interfaces."
  },
  {
    num: "03",
    title: "BUILD",
    icon: <Code className="w-5 h-5 text-[#7CFF6B]" />,
    description: "Develop clean, maintainable, and modular code using Shopify Liquid, React, Next.js, and TypeScript best practices."
  },
  {
    num: "04",
    title: "OPTIMIZE",
    icon: <Gauge className="w-5 h-5 text-[#7CFF6B]" />,
    description: "Rigorously audit site speed, Core Web Vitals, mobile responsiveness, accessibility, and organic SEO metadata."
  },
  {
    num: "05",
    title: "LAUNCH",
    icon: <Rocket className="w-5 h-5 text-[#7CFF6B]" />,
    description: "Deploy to production, perform cross-browser testing, establish tracking, and provide ongoing technical support."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16 space-y-4">
          ...
          <p className="text-base text-[#A1A1A1] font-sans leading-relaxed">
            A structured, transparent problem-solving workflow engineered to convert business objectives into high-performing digital products.
          </p>
        </div>
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-xl font-bold text-[#7CFF6B]">{step.num}</span>
